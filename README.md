![Main Dashboard Interface](image-1.png)
...
* **Dual-Model Deployment:** The application features a model-switcher to compare the "Core Model" (4k training rows) against a "Comprehensive Model" (5k training rows).
...
## Performance Summary
* Evaluated against a 1,000-row "Production Simulation" dataset (unseen by the Core model):
